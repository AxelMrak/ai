...
### RULE: Narrow Effect Dependencies
...
### RULE: Calculate Derived State During Rendering
...
### RULE: Use Functional setState Updates
...
### RULE: Extract Default Non-primitive Parameter Value from Memoized Component to Constant
...
### RULE: Do not wrap a simple expression with a primitive result type in useMemo
...
### RULE: Use useRef for Transient Values
