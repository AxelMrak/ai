# VERCEL-REACT-NATIVE-SKILLS - ANIMATION
> Generated: 2026-02-17
> Rules: 3


### RULE: Prefer useDerivedValue Over useAnimatedReaction
(File: animation-derived-value.md)
...
### RULE: Use GestureDetector for Animated Press States
(File: animation-gesture-detector-press.md)
...
### RULE: Animate Transform and Opacity Instead of Layout Properties
(File: animation-gpu-properties.md)
