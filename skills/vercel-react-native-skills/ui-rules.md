# VERCEL-REACT-NATIVE-SKILLS - UI
> Generated: 2026-02-17
> Rules: 9


### RULE: Use expo-image for Optimized Images
(File: ui-expo-image.md)
...
### RULE: Use Galeria for Image Galleries and Lightbox
(File: ui-image-gallery.md)
...
### RULE: Measuring View Dimensions
(File: ui-measure-views.md)
...
### RULE: Use Native Menus for Dropdowns and Context Menus
(File: ui-menus.md)
...
### RULE: Use Native Modals Over JS-Based Bottom Sheets
(File: ui-native-modals.md)
...
### RULE: Use Pressable Instead of Touchable Components
(File: ui-pressable.md)
...
### RULE: Use contentInsetAdjustmentBehavior for Safe Areas
(File: ui-safe-area-scroll.md)
...
### RULE: Use contentInset for Dynamic ScrollView Spacing
(File: ui-scrollview-content-inset.md)
...
### RULE: Modern React Native Styling Patterns
(File: ui-styling.md)
