# VERCEL-REACT-NATIVE-SKILLS - LIST
> Generated: 2026-02-17
> Rules: 8


### RULE: Hoist callbacks to the root of lists
(File: list-performance-callbacks.md)
...
### RULE: Optimize List Performance with Stable Object References
(File: list-performance-function-references.md)
...
### RULE: Use Compressed Images in Lists
(File: list-performance-images.md)
...
### RULE: Avoid Inline Objects in renderItem
(File: list-performance-inline-objects.md)
...
### RULE: Keep List Items Lightweight
(File: list-performance-item-expensive.md)
...
### RULE: Pass Primitives to List Items for Memoization
(File: list-performance-item-memo.md)
...
### RULE: Use Item Types for Heterogeneous Lists
(File: list-performance-item-types.md)
...
### RULE: Use a List Virtualizer for Any List
(File: list-performance-virtualize.md)
